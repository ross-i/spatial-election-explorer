...
consider
a set of friends choosing what movie to watch or restaurant to visit;
...
There are many algorithms for aggregating these group preferences:
...
Combining visualization and iterative experimentation
allows users to \textit{see} the properties of the various algorithms
...
Voters thus prefer candidates that are "similar" to themselves.
...
the position of voters and candidates might, for example, represent their
...
Their positions determine a unique preference profile,
which can be used as input to any of various voting methods.
The winners are displayed, providing the user a visual description how the distribution of winners
differs according to the choice of voting rule.
...
Visualization may also suggest behavior patterns in these voting rules that can
be axiomatized and studied formally.
\item[2.] Students studying social choice theory can use the tool to develop intuition
for the behavior of voting rules that supplements their learnings in the
