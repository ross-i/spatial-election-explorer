...
\begin{itemize}
  ...
  \item \textbf{Survey Data.}
    ...
    the user can select two ideology or political issue axes to serve as the axes of the plot.
    Then, they can view the distribution of political opinion survey respondents across these axes
    and, by answering the survey questions,
    can simulate the position of a candidate with specific views.
...
\begin{itemize}
  \item \textbf{Edit.}
    ...
    any of the settings (including type, count, position, and parameters)
...
topics passed this threshold (ranging from 51–79\%); four questions were excluded.
...
% TODO: add details explaining how this actually works
Question weights are assigned by linear decay based on the user's ranking---the
