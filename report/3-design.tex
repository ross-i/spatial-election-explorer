...
\begin{itemize}
  ...
  \item \textbf{Survey Data.}
    ...
    Methodology details are described in Section \ref{sub:Survey Data}.
...
sex, race, ZIP code, income level, education level, and religiosity;
whether and for whom they plan to vote in the upcoming election;
...
From this survey, we identified three political topics to use as axes:
