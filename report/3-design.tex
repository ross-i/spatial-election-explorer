...
centrist "consensus" candidates. Lastly, within the multi-winner setting, users discover that
...
\begin{itemize}
  ...
  \item \textbf{Synthetic Sampling.}
    ...
    Then users then select the type of point, voters or candidates, to be randomly sampled from the specified distribution, 
  ...
  \item \textbf{Survey Data.}
    ...
    survey question themselves to create a 'Profile candidate'.
...
%
The survey asks respondents for demographic details---such as
