...
Deliberation among the group members about this decision
might rely on the details of the algorithms,
or on appeals to axiomatic properties that such algorithms may or may not satisfy.
They might say that Single Transferable Vote (STV) is "more proportional"
...
ranked choice voting and wondering what voting rule to use can use
the tool as they develop intuition about how outcomes vary across voting rules.
